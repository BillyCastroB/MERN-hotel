...
export const Contactanos = () => {
  return (
    <>
         <section>
            <h2 className="subtittle">Contactanos</h2>
            <div>
                <p className="descripcion">¡Nos encantaría conocerte! Si quieres ponerte en contacto con nosotros, no dudes en enviarme un mensaje. Estamos disponibles y emocionados por hablar contigo.</p>
            </div>
        </section>
        <section className="section-contacto">
            <div className="contacto-info">
                <h3>Comunicate mediante:</h3>
